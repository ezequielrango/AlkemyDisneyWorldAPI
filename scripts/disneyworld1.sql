CREATE DATABASE  IF NOT EXISTS `disneyworld1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `disneyworld1`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: disneyworld1
-- ------------------------------------------------------
...
CREATE TABLE `moviecharacter` (
  ...
  CONSTRAINT `characterId` FOREIGN KEY (`characterId`) REFERENCES `characters` (`id`),
...
INSERT INTO `users` VALUES (8,'juan@outlook.com','$2a$10$B42QtfTs..pMoAeRmTMkA./EXN8.piMu6zuYx2EwYcWK3WYW2xrsu'),(9,'eze@outlook.com','$2a$10$6K31z6kx0sHJwOzOzDVy5ulqft5hwNbDxG8cGxdbi4NMhauuZeXY.');
...
-- Dump completed on 2021-12-04 23:54:08
